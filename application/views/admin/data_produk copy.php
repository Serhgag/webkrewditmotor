	...
	<table class="table table-bordered">
		...
		foreach ($produk as $produk) : ?>
			...
			<tr>
				...
				<td><?php echo anchor('admin/datauser/edit/' . $produk->id, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>') ?></td>
				<td><?php echo anchor('admin/data_produk/hapus/' . $produk->id, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>') ?></td>
